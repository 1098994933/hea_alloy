...
if __name__ == '__main__':
    ...
    # plt.xlabel("Measured(hardness)", fontsize=8, fontweight='bold')
    # plt.ylabel("Predicted(hardness)", fontsize=8, fontweight='bold')
    ...
    # pre_chemistry_formula.to_csv("./data/formula_hardness_26wpred.csv", index=False)
    predata_magpie = get_magpie_features("formula_hardness_26wpred.csv", data_path="./data/")
    feature_file_path_pre = os.path.join(data_path, "magpie_feature_hardness_26wpred.csv")
    ...
    final.to_csv("./data/hardness_prediction_first1000_result.csv", index=False)
    print(final)
